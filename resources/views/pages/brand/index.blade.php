        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <table class="table datatable" style="width: 100%; white-space: nowrap">
                    ...
                    <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('brand.destroy', $brand->id) }}" method="POST">
                            <!-- <a href="{{ route('brand.show', $brand->id) }}"><button type="button" class="btn btn-primary"><i class="bi bi-info-circle"></i></button></a>  -->
                            <a href="{{ route('brand.edit', $brand->id) }}"><button type="button" class="btn btn-warning"><i class="bi bi-pencil"></i></button></a>
