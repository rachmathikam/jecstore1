                    ...
                    <div class="card">
                        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                            ...
                            @if (strlen($data->image) > 0)
                                <img src="{{ asset('image/profile/' . $data->image) }}" width="80px" alt="Profile"
                                    class="rouded-circle" />
                            @else
                                <img src="{{ asset('assets/img/default.jpg') }}" width="80px" alt="Profile">
                            @endif
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                @if (strlen($data->photo) > 0)
                                                    <img src="{{ asset('image/profile/' . $data->image) }}" width="80px"
                                                        alt="Profile">

                                                    <img src="{{ asset('assets/img/default.jpg') }}" width="80px"
                                                        alt="Profile">
                                                @endif
                                                <div class="pt-2">
                                                    ...
                                                    <select name="role" id="role"
                                                        ...
                                                        @foreach ($roles as $role)
                                                            <option value="{{ $role->id }}"
                                                                @selected($role->id == $userRole->id)>{{ $role->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    </select>
                                                </div>
